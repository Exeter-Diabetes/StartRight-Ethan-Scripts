...
``` {r Clin F + Anti Model Discerns Antibody Positivity}
...
#Distribution 2.0: Boxplot
ggplot(Type2_cohort,aes(as.factor(Antibody_Positive), model_clinF_Anti)) +
  geom_boxplot() +
...
# ROC AUC
glm.fit = glm(roc_data$Antibody_Positive ~ roc_data$model_clinF_Anti, family = binomial())
plot.new()
lines(roc_data$model_clinF_Anti, glm.fit$fitted.values)
